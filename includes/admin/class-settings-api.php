...
if ( ! class_exists( 'Ever_Settings_API' ) ):
    class Ever_Settings_API {
        ...
        function callback_file( $args ) {
            ...
            $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'event-calendar-pro' );
            ...
            <div class="ever-settings-content">
                <?php foreach ( $this->settings_sections as $form ) { ?>
                    ...
                    <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
	                    <?php if($form['id'] == 'ecp_countries' or $form['id'] == 'ecp_states'){ ?>
                        <form method="post" action="">
                            ...
                            if($form['id'] == 'ecp_countries'){
	                            ob_start();
	                            include WPECP_VIEWS.'/settings/country.php';
	                            $html = ob_get_clean();
	                            echo $html;
                            }elseif($form['id'] == 'ecp_states'){
	                            ob_start();
	                            include WPECP_VIEWS.'/settings/states.php';
	                            $html = ob_get_clean();
	                            echo $html;
                            }else{
                            ...
                            if ( isset( $this->settings_fields[ $form['id'] ] ) ):
                                ?>
                            <?php if($form['id'] != 'ecp_countries' and $form['id'] != 'ecp_states'){ ?>
