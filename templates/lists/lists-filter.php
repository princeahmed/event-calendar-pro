...
<div class="row">
	<div class="col-md-12">
		<div class="ecp-widget-event-filter event-listing">
			...
			<h4 class="title">Search in Events:</h4>
			...
			<form action="<?php echo ecp_get_page_url( 'events_page' ); ?>" method="get">
				...
				<div class="form-group ecp-search-filter">
					<input type="search" name="search_keyword" class="form-control" placeholder="Search for." value="<?php echo ( ! empty( $_GET['search_keyword'] ) ) ? $_GET['search_keyword'] : ''; ?>">
