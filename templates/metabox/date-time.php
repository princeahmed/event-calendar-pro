...
<div class="ecp-date-time-meta-data">
	...
	<div class="ecp-row">
		...
		<div class="form-group">
			...
			<input type='text' class="form-table form-control ecp-date-calendar" autocomplete="off" name="startdate" placeholder="<?php echo date( 'Y-m-d' ); ?>" value="<?php echo $startdate; ?>" required/>
		</div>

		<div class="form-group">
			<label for="starttime"><?php _e( 'Start Time:', 'event-calendar-pro' ); ?></label>
			<input type='text' class="form-table form-control  ecp-time-calendar" autocomplete="off" name="starttime" placeholder="9:00 AM" value="<?php echo $starttime; ?>" />
		</div>
	...
	<div class="ecp-row">
		...
		<div class="form-group">
			...
			<input type='text' class="form-table form-control ecp-date-calendar" autocomplete="off" name="enddate" placeholder="<?php echo date( 'Y-m-d' ); ?>" value="<?php echo $enddate ?>"/>
		</div>

		<div class="form-group">
			<label for="endtime"><?php _e( 'End Time:', 'event-calendar-pro' ); ?>
				<span class="ecp-requirede"></span></label>
			<input type='text' class="form-table form-control ecp-time-calendar" autocomplete="off" name="endtime" placeholder="10:00 PM" value="<?php echo $endtime; ?>" />
		</div>
